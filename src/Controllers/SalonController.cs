...
namespace KuaforSalonu.Controllers
{
    public class SalonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Isim,Adres,IletisimBilgisi,CalismaSaatleri")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Isim,Adres,IletisimBilgisi,CalismaSaatleri")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
