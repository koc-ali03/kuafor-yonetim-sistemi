...
namespace KuaforSalonu.Controllers
{
    public class ServisController : Controller
    {
        ...
        public ServisController(KuaforDbContext context)
        {
            _context = context;
        }
        ...
        {
            var kuaforDbContext = _context.Servisler.Include(s => s.Calisan);
            return View(await kuaforDbContext.ToListAsync());
        }
